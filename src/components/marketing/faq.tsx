...
const faqs = [
  {
    ...
    answer: 'Most creators can create an account, import a CSV, and build a first welcome workflow in one sitting. You can start simple, then add segments and reporting as your workflow gets sharper.',
    category: 'setup',
    icon: Clock3,
  ...
  {
    question: 'Does CreatorHub connect directly to OnlyFans?',
    answer: 'No. CreatorHub is an independent workspace, not an official OnlyFans integration or API partner. Most teams use CSV imports and creator-entered data, then use CreatorHub to organize segments, pricing decisions, and message playbooks.',
    category: 'setup',
    icon: Shield,
    gradient: 'from-violet-500 to-purple-500',
  },
  {
    question: 'What can I do with message workflows?',
    answer: 'Message workflows help you plan welcome sequences, follow-ups, re-engagement, and other repeatable plays inside CreatorHub. Any platform-side sending or publishing should still be reviewed against your own workflow and platform policies.',
    category: 'setup',
    icon: MessageSquare,
    gradient: 'from-green-500 to-emerald-500',
  },
  {
    question: 'How does pricing guidance work?',
  ...
  },
  {
    ...
    answer: 'Yes. The Agency plan is designed for multi-account visibility, shared reporting, and teams handling more than one creator workflow.',
    category: 'billing',
    icon: Users,
            ...
            <div className="w-full max-w-3xl rounded-3xl border border-gray-200 bg-white/90 p-6 shadow-xl dark:border-gray-700 dark:bg-gray-800/90 sm:flex sm:items-center sm:justify-between sm:gap-6">
              <div className="max-w-xl">
                ...
                <p className="mt-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                  Tell us how you manage subscriber data today and we&apos;ll help you figure
                  out which plan and workflow make sense first.
                </p>
              </div>
              <Link
                href="/contact"
